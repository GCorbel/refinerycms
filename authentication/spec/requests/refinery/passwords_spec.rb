    ...
    describe "password recovery" do
      ...
      context "when existing email specified" do
        it "shows success message" do
          get refinery.new_refinery_user_password_path
      ...
      context "when good reset code" do
        ...
        it "allows to change password" do
          get refinery.edit_refinery_user_password_path(:reset_password_token => user.reset_password_token)
      ...
      context "when invalid reset code" do
        ...
        it "shows error message" do
          get refinery.edit_refinery_user_password_path(:reset_password_token => "hmmm")
      ...
      context "when expired reset code" do
        ...
        it "shows error message" do
          get refinery.edit_refinery_user_password_path(:reset_password_token => "refinerycms")
